...
public class Customer extends TableImpl<CustomerRecord> {
    ...
    private static final long serialVersionUID = -1138391516;
     ...
     */
    public final TableField<CustomerRecord, Long> CUSTOMER_ID = createField("CUSTOMER_ID", org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>PUBLIC.CUSTOMER.FIRST_NAME</code>.
     */
    public final TableField<CustomerRecord, String> FIRST_NAME = createField("FIRST_NAME", org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>PUBLIC.CUSTOMER.LAST_NAME</code>.
     */
    public final TableField<CustomerRecord, String> LAST_NAME = createField("LAST_NAME", org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "");
    ...
    /**
     * The column <code>PUBLIC.CUSTOMER.SOFT_DELETED</code>.
     */
    public final TableField<CustomerRecord, String> SOFT_DELETED = createField("SOFT_DELETED", org.jooq.impl.SQLDataType.VARCHAR(50).defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.IDX_CE, Indexes.PRIMARY_KEY_5);
    }
